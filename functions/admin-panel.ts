    ...
    <div class="tab-content" id="content-parents">
      <div class="card">
        ...
        <div class="search-row">
          ...
          <button class="btn-sm" onclick="switchTab('students');setTimeout(function(){var el=document.getElementById('apsParentName');if(el)el.focus()},150)">+ Add Parent / Student</button>
        </div>
