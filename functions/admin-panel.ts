  ...
  <main class="main">
    ...
    <div class="tab-content active" id="content-overview">
      ...
      <div class="card">
        ...
        <ol class="flow-list">
          ...
          <li><b>Get invite links</b>: Each provisioned parent gets a unique invite link. Copy or share it yourself (WhatsApp, SMS, email — whatever you already use).</li>
    ...
    <div class="tab-content" id="content-import">
      ...
      <div class="card">
        ...
        <p style="margin:-2px 0 10px;color:var(--ink-faint);font-size:11px">No SMS is sent automatically. After import, copy or share each parent's invite link yourself, or use “Copy All Links” in the results below.</p>
...
9876543210,Aarav Sharma,Rahul Sharma,M,Class 3,7,OAK2026,Oakridge International School,2026-07-15,Annual Health Camp,115,22,GOOD,GOOD,GOOD,STU001"></textarea>
        ...
        <div class="checkbox-row"><input type="checkbox" id="generateLinks" checked><label for="generateLinks">Generate invite links after import (you'll copy/share these yourself)</label></div>
