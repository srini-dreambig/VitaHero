package kallam.healthcare.ui.navigation
...
import kallam.healthcare.data.BookingViewModel
import kallam.healthcare.data.LocalAppLocale
import kallam.healthcare.data.PdfReportGenerator
import kallam.healthcare.data.ReportData
import kallam.healthcare.data.rememberVitaHeroViewModels
import kallam.healthcare.ui.components.selectAsState
import kallam.healthcare.ui.screens.ClinicianCampsScreen
import kallam.healthcare.ui.screens.ClinicianReviewChildScreen
import kallam.healthcare.ui.screens.ClinicianReviewScreen
import kallam.healthcare.ui.screens.ClinicianRosterScreen
import kallam.healthcare.ui.screens.ClinicianScreeningScreen
import kallam.healthcare.ui.screens.AuthScreen
import kallam.healthcare.ui.screens.BookingScreen
import kallam.healthcare.ui.screens.CampConsentScreen
import kallam.healthcare.ui.screens.CampResultScreen
import kallam.healthcare.ui.screens.LibraryScreen
import kallam.healthcare.ui.screens.PrivacyScreen
import kallam.healthcare.ui.screens.QuestionsScreen
import kallam.healthcare.ui.screens.ReferralsScreen
import kallam.healthcare.ui.screens.CampDetailScreen
import kallam.healthcare.ui.screens.ConsentScreen
import kallam.healthcare.ui.screens.DietScreen
import kallam.healthcare.ui.screens.DieticianArticlesScreen
import kallam.healthcare.ui.screens.DieticianChildScreen
import kallam.healthcare.ui.screens.DieticianChildrenScreen
import kallam.healthcare.ui.screens.DieticianSchoolsScreen
import kallam.healthcare.ui.screens.FamilySharingScreen
import kallam.healthcare.ui.screens.FoodRecognitionScreen
import kallam.healthcare.ui.screens.GrowthChartsScreen
import kallam.healthcare.ui.screens.HospitalsScreen
import kallam.healthcare.ui.screens.KidDetailMissingScreen
import kallam.healthcare.ui.screens.KidDetailScreen
import kallam.healthcare.ui.screens.MainScaffold
import kallam.healthcare.ui.screens.NotificationsScreen
import kallam.healthcare.ui.screens.OnboardingScreen
import kallam.healthcare.ui.screens.OtpScreen
import kallam.healthcare.ui.screens.SchoolsScreen
import kallam.healthcare.ui.screens.SplashScreen
import kallam.healthcare.ui.screens.SymptomScreen
...
/**
 * The onboarding slides carry no artwork.
 *
 * They used to load four photographs from a CDN belonging to the platform
 * this app was originally built on. That is a dependency on somebody else
 * continuing to serve files for a product they are no longer part of: the day
 * those URLs stop answering, every new user's first four screens are empty
 * boxes, and nothing in a release would have warned us.
 *
 * OnboardingScreen already draws a slide with no image — a rounded panel in
 * the slide's own accent colour, above the title and the subtitle — so this
 * reads as a design rather than a failure. Bundle four drawables here when
 * there is art to bundle; a list of local resources is the only version of
 * this that cannot break while the app is installed.
 */
