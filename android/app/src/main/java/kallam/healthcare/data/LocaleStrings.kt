...
object S {
    ...
    const val heroOfMonthTitle = "hero_of_month_title"
    const val heroNameAskTitle = "hero_name_ask_title"
    const val heroNameAskBody = "hero_name_ask_body"
    const val heroNameYes = "hero_name_yes"
    const val heroNameNo = "hero_name_no"

    // ---- Meal photographs ----
    // A photograph taken in a family's kitchen, not at a camp. Asked once,
    // per child, and both answers leave a working feature.
    const val mealPhotoAskTitle = "meal_photo_ask_title"
    const val mealPhotoAskBody = "meal_photo_ask_body"
    const val mealPhotoAllow = "meal_photo_allow"
    const val mealPhotoKeepOnPhone = "meal_photo_keep_on_phone"
    const val mealPhotoOnDevice = "meal_photo_on_device"
    ...
    // ── What a parent may enter, and what they may not ──
    ...
    const val symptomsNoticeFallback = "symptoms_notice_fallback"
    const val whatHappened = "what_happened"
    const val howBad = "how_bad"
    const val severityMild = "severity_mild"
    const val severityModerate = "severity_moderate"
    const val whenStarted = "when_started"
    const val dayToday = "day_today"
    const val dayYesterday = "day_yesterday"
    const val dayNAgo = "day_n_ago"
    const val stillUnwell = "still_unwell"
    const val missedSchool = "missed_school"
    const val sawADoctor = "saw_a_doctor"
    const val symptomNoteHint = "symptom_note_hint"
    const val saveSymptom = "save_symptom"
    const val symptomNotADiagnosis = "symptom_not_a_diagnosis"
    const val symptomSaved = "symptom_saved"
    const val symptomFailed = "symptom_failed"
    const val seeADoctor = "see_a_doctor"
    const val pastIllnesses = "past_illnesses"
    const val pastIllnessesSub = "past_illnesses_sub"
    const val ongoingLabel = "ongoing_label"
    const val eraseTitle = "erase_title"
    const val eraseBody = "erase_body"
    const val eraseAction = "erase_action"
    const val eraseConfirm = "erase_confirm"
    const val childErased = "child_erased"
    const val childEraseFailed = "child_erase_failed"

    // ── Badges, navigation, and labels that were English-only ──
    const val badgeSuperEater = "badge_super_eater"
    const val badgeSuperEaterSub = "badge_super_eater_sub"
    const val badgeEveryMeal = "badge_every_meal"
    const val badgeEveryMealSub = "badge_every_meal_sub"
    const val badgeThreeDay = "badge_three_day"
    const val badgeThreeDaySub = "badge_three_day_sub"
    const val badgeTwoWeek = "badge_two_week"
    const val badgeTwoWeekSub = "badge_two_week_sub"
    const val badgeBrightSmile = "badge_bright_smile"
    const val badgeBrightSmileSub = "badge_bright_smile_sub"
    const val badgeBrightSmileUnknown = "badge_bright_smile_unknown"
    const val badgeHalfWay = "badge_half_way"
    const val badgeHalfWaySub = "badge_half_way_sub"
    const val notScreenedYet = "not_screened_yet"
    const val clearLabel = "clear_label"
    const val logLabel = "log_label"
    const val foodRecognition = "food_recognition"
    const val navHome = "nav_home"
    const val navKids = "nav_kids"
    ...
    const val noGrowthDataSub = "no_growth_data_sub"
...
private val en = mapOf(
    ...
    S.heroOfMonthTitle to "VitaHero of the month",
    S.heroNameAskTitle to "If your child is chosen",
    S.heroNameAskBody to "Each month a school celebrates one child. If yours is chosen, may we show their first name and class to other families? Say no and they can still be chosen \u2014 they will simply appear as \"a pupil in their class\". You can change this at any time, and it applies to months already published.",
    S.heroNameYes to "Show their first name",
    S.heroNameNo to "Do not show their name",
    S.mealPhotoAskTitle to "Where should meal photos go?",
    S.mealPhotoAskBody to "To name a dish more accurately we can send the photo to our server to be read. Or we can read it here on your phone, and the photo never leaves it. Either way the meal is logged \u2014 reading it here is just a little less accurate. You can change this later.",
    S.mealPhotoAllow to "Send photos to be read",
    S.mealPhotoKeepOnPhone to "Keep photos on this phone",
    S.mealPhotoOnDevice to "Photos are read on this phone and never sent.",
    ...
    S.deleteKidBody to "Everything held for this child is permanently deleted.",
    ...
    S.symptomsNoticeFallback to "This is a note for your child's next check-up, not a way to get help now. If your child needs a doctor today, take them to one.",
    S.whatHappened to "What happened?",
    S.howBad to "How bad was it?",
    S.severityMild to "Mild",
    S.severityModerate to "Bad enough to worry",
    S.whenStarted to "When did it start?",
    S.dayToday to "Today",
    S.dayYesterday to "Yesterday",
    S.dayNAgo to "%s days ago",
    S.stillUnwell to "Still unwell",
    S.missedSchool to "Missed school",
    S.sawADoctor to "We saw a doctor",
    S.symptomNoteHint to "Anything else worth noting (optional)",
    S.saveSymptom to "Save",
    S.symptomNotADiagnosis to "This is your account of what happened, not a diagnosis. The doctor at the next camp can read it.",
    S.symptomSaved to "Saved.",
    S.symptomFailed to "We could not save that. Please try again.",
    S.seeADoctor to "See a doctor",
    S.pastIllnesses to "What you have recorded",
    S.pastIllnessesSub to "The doctor at your child's next camp can see this.",
    S.ongoingLabel to "Ongoing",
    S.eraseTitle to "Delete a child's record",
    S.eraseBody to "This deletes everything: camp results, follow-ups, photographs and this illness log. It cannot be undone, and the school cannot get it back.",
    S.eraseAction to "Delete",
    S.eraseConfirm to "Yes, delete",
    S.childErased to "Deleted. Nothing is left.",
    S.childEraseFailed to "We could not delete that. Please try again.",
    S.badgeSuperEater to "Super Eater",
    S.badgeSuperEaterSub to "Logged every meal, 7 days running",
    S.badgeEveryMeal to "Clean Plate",
    S.badgeEveryMealSub to "Every meal today marked eaten",
    S.badgeThreeDay to "Three in a Row",
    S.badgeThreeDaySub to "Meals logged three days running",
    S.badgeTwoWeek to "Fortnight Streak",
    S.badgeTwoWeekSub to "Best streak of 14 days",
    S.badgeBrightSmile to "Bright Smile",
    S.badgeBrightSmileSub to "No cavities at the last school check",
    S.badgeBrightSmileUnknown to "Waiting for a dental check at a camp",
    S.badgeHalfWay to "Good Start",
    S.badgeHalfWaySub to "Half of today's meals logged",
    S.notScreenedYet to "Not screened yet",
    S.clearLabel to "Clear",
    S.logLabel to "Log",
    S.foodRecognition to "Identify food",
    S.navHome to "Home",
    S.navKids to "Children",
    S.navCamps to "Camps",
    ...
    S.noGrowthDataSub to "Height and weight are measured at a school health camp. The chart appears once your child has been screened.",
)
...
private val hi = mapOf(
    ...
    S.heroOfMonthTitle to "\u0907\u0938 \u092E\u0939\u0940\u0928\u0947 \u0915\u093E \u0935\u0940\u091F\u093E\u0939\u0940\u0930\u094B",
    S.heroNameAskTitle to "\u0905\u0917\u0930 \u0906\u092A\u0915\u093E \u092C\u091A\u094D\u091A\u093E \u091A\u0941\u0928\u093E \u091C\u093E\u090F",
    S.heroNameAskBody to "\u0939\u0930 \u092E\u0939\u0940\u0928\u0947 \u0938\u094D\u0915\u0942\u0932 \u090F\u0915 \u092C\u091A\u094D\u091A\u0947 \u0915\u094B \u0938\u092E\u094D\u092E\u093E\u0928\u093F\u0924 \u0915\u0930\u0924\u093E \u0939\u0948\u0964 \u0915\u094D\u092F\u093E \u0939\u092E \u0909\u0928\u0915\u093E \u092A\u0939\u0932\u093E \u0928\u093E\u092E \u0914\u0930 \u0915\u0915\u094D\u0937\u093E \u0926\u0942\u0938\u0930\u0947 \u092A\u0930\u093F\u0935\u093E\u0930\u094B\u0902 \u0915\u094B \u0926\u093F\u0916\u093E \u0938\u0915\u0924\u0947 \u0939\u0948\u0902? \u0928\u093E \u0915\u0939\u0928\u0947 \u092A\u0930 \u092D\u0940 \u0935\u0947 \u091A\u0941\u0928\u0947 \u091C\u093E \u0938\u0915\u0924\u0947 \u0939\u0948\u0902\u0964 \u0906\u092A \u0915\u092D\u0940 \u092D\u0940 \u092C\u0926\u0932 \u0938\u0915\u0924\u0947 \u0939\u0948\u0902\u0964",
    S.heroNameYes to "\u092A\u0939\u0932\u093E \u0928\u093E\u092E \u0926\u093F\u0916\u093E\u090F\u0902",
    S.heroNameNo to "\u0928\u093E\u092E \u0928 \u0926\u093F\u0916\u093E\u090F\u0902",
    S.mealPhotoAskTitle to "\u092D\u094B\u091C\u0928 \u0915\u0940 \u092B\u093C\u094B\u091F\u094B \u0915\u0939\u093E\u0901 \u091C\u093E\u090F\u0902?",
    S.mealPhotoAskBody to "\u0916\u093E\u0928\u0947 \u0915\u093E \u0928\u093E\u092E \u0920\u0940\u0915 \u0938\u0947 \u092C\u0924\u093E\u0928\u0947 \u0915\u0947 \u0932\u093F\u090F \u0939\u092E \u092B\u093C\u094B\u091F\u094B \u0905\u092A\u0928\u0947 \u0938\u0930\u094D\u0935\u0930 \u092A\u0930 \u092D\u0947\u091C \u0938\u0915\u0924\u0947 \u0939\u0948\u0902\u0964 \u092F\u093E \u0939\u092E \u0907\u0938\u0947 \u0907\u0938\u0940 \u092B\u093C\u094B\u0928 \u092A\u0930 \u092A\u0922\u093C स\u0915\u0924\u0947 \u0939\u0948\u0902, \u0914\u0930 \u092B\u093C\u094B\u091F\u094B \u0915\u092D\u0940 \u092C\u093E\u0939\u0930 \u0928\u0939\u0940\u0902 \u091C\u093E\u090F\u0917\u0940\u0964 \u0926\u094B\u0928\u094B\u0902 \u0924\u0930\u0939 \u092D\u094B\u091C\u0928 \u0926\u0930\u094D\u091C \u0939\u094B\u0917\u093E\u0964 \u0906\u092A \u092C\u093E\u0926 \u092E\u0947\u0902 \u092C\u0926\u0932 \u0938\u0915\u0924\u0947 \u0939\u0948\u0902\u0964",
    S.mealPhotoAllow to "\u092B\u093C\u094B\u091F\u094B \u092D\u0947\u091C\u0947\u0902",
    S.mealPhotoKeepOnPhone to "\u092B\u093C\u094B\u091F\u094B \u0907\u0938\u0940 \u092B\u093C\u094B\u0928 \u092E\u0947\u0902 \u0930\u0916\u0947\u0902",
    S.mealPhotoOnDevice to "\u092B\u093C\u094B\u091F\u094B \u0907\u0938\u0940 \u092B\u093C\u094B\u0928 \u092A\u0930 \u092A\u0922\u093C\u0940 \u091C\u093E\u0924\u0940 \u0939\u0948, \u092D\u0947\u091C\u0940 \u0928\u0939\u0940\u0902 \u091C\u093E\u0924\u0940\u0964",
    ...
    S.symptomsNoticeFallback to "\u092F\u0939 \u0906\u092A\u0915\u0947 \u092C\u091A\u094D\u091A\u0947 \u0915\u0940 \u0905\u0917\u0932\u0940 \u091C\u093E\u0901\u091A \u0915\u0947 \u0932\u093F\u090F \u090F\u0915 \u0928\u094B\u091F \u0939\u0948, \u0905\u092D\u0940 \u092E\u0926\u0926 \u092A\u093E\u0928\u0947 \u0915\u093E \u0924\u0930\u0940\u0915\u093E \u0928\u0939\u0940\u0902\u0964 \u0905\u0917\u0930 \u0906\u092A\u0915\u0947 \u092C\u091A\u094D\u091A\u0947 \u0915\u094B \u0906\u091C \u0921\u0949\u0915\u094D\u091F\u0930 \u091A\u093E\u0939\u093F\u090F, \u0924\u094B \u0909\u0928\u094D\u0939\u0947\u0902 \u0921\u0949\u0915\u094D\u091F\u0930 \u0915\u0947 \u092A\u093E\u0938 \u0932\u0947 \u091C\u093E\u090F\u0901\u0964",
    S.whatHappened to "\u0915\u094D\u092F\u093E \u0939\u0941\u0906?",
    S.howBad to "\u0915\u093F\u0924\u0928\u093E \u0917\u0902\u092D\u0940\u0930 \u0925\u093E?",
    S.severityMild to "\u0939\u0932\u094D\u0915\u093E",
    S.severityModerate to "\u091A\u093F\u0902\u0924\u093E \u091C\u093F\u0924\u0928\u093E",
    S.whenStarted to "\u0915\u092C \u0936\u0941\u0930\u0942 \u0939\u0941\u0906?",
    S.dayToday to "\u0906\u091C",
    S.dayYesterday to "\u0915\u0932",
    S.dayNAgo to "%s \u0926\u093F\u0928 \u092A\u0939\u0932\u0947",
    S.stillUnwell to "\u0905\u092D\u0940 \u092D\u0940 \u092C\u0940\u092E\u093E\u0930",
    S.missedSchool to "\u0938\u094D\u0915\u0942\u0932 \u0928\u0939\u0940\u0902 \u0917\u090F",
    S.sawADoctor to "\u0939\u092E\u0928\u0947 \u0921\u0949\u0915\u094D\u091F\u0930 \u0915\u094B \u0926\u093F\u0916\u093E\u092F\u093E",
    S.symptomNoteHint to "\u0914\u0930 \u0915\u0941\u091B \u092C\u0924\u093E\u0928\u093E \u091A\u093E\u0939\u0947\u0902 (\u0935\u0948\u0915\u0932\u094D\u092A\u093F\u0915)",
    S.saveSymptom to "\u0938\u0939\u0947\u091C\u0947\u0902",
    S.symptomNotADiagnosis to "\u092F\u0939 \u0906\u092A\u0915\u093E \u0935\u093F\u0935\u0930\u0923 \u0939\u0948, \u0915\u094B\u0908 \u0928\u093F\u0926\u093E\u0928 \u0928\u0939\u0940\u0902\u0964 \u0905\u0917\u0932\u0947 \u0915\u0948\u0902\u092A \u0915\u0947 \u0921\u0949\u0915\u094D\u091F\u0930 \u0907\u0938\u0947 \u092A\u0922\u093C \u0938\u0915\u0924\u0947 \u0939\u0948\u0902\u0964",
    S.symptomSaved to "\u0938\u0939\u0947\u091C \u0932\u093F\u092F\u093E \u0917\u092F\u093E\u0964",
    S.symptomFailed to "\u0939\u092E \u0907\u0938\u0947 \u0938\u0939\u0947\u091C \u0928\u0939\u0940\u0902 \u0938\u0915\u0947\u0964 \u0915\u0943\u092A\u092F\u093E \u0926\u094B\u092C\u093E\u0930\u093E \u0915\u094B\u0936\u093F\u0936 \u0915\u0930\u0947\u0902\u0964",
    S.seeADoctor to "\u0921\u0949\u0915\u094D\u091F\u0930 \u0915\u094B \u0926\u093F\u0916\u093E\u090F\u0901",
    S.pastIllnesses to "\u0906\u092A\u0928\u0947 \u091C\u094B \u0926\u0930\u094D\u091C \u0915\u093F\u092F\u093E",
    S.pastIllnessesSub to "\u0906\u092A\u0915\u0947 \u092C\u091A\u094D\u091A\u0947 \u0915\u0947 \u0905\u0917\u0932\u0947 \u0915\u0948\u0902\u092A \u0915\u0947 \u0921\u0949\u0915\u094D\u091F\u0930 \u0907\u0938\u0947 \u0926\u0947\u0916 \u0938\u0915\u0924\u0947 \u0939\u0948\u0902\u0964",
    S.ongoingLabel to "\u091C\u093E\u0930\u0940 \u0939\u0948",
    S.eraseTitle to "\u092C\u091A\u094D\u091A\u0947 \u0915\u093E \u0930\u093F\u0915\u0949\u0930\u094D\u0921 \u0939\u091F\u093E\u090F\u0901",
    S.eraseBody to "\u0907\u0938\u0938\u0947 \u0938\u092C \u0915\u0941\u091B \u0939\u091F \u091C\u093E\u090F\u0917\u093E: \u0915\u0948\u0902\u092A \u0915\u0947 \u0928\u0924\u0940\u091C\u0947, \u0906\u0917\u0947 \u0915\u0940 \u0915\u093E\u0930\u094D\u0930\u0935\u093E\u0908, \u092B\u093C\u094B\u091F\u094B \u0914\u0930 \u092F\u0939 \u092C\u0940\u092E\u093E\u0930\u0940 \u0930\u093F\u0915\u0949\u0930\u094D\u0921\u0964 \u0907\u0938\u0947 \u0935\u093E\u092A\u0938 \u0928\u0939\u0940\u0902 \u0932\u093E\u092F\u093E \u091C\u093E \u0938\u0915\u0924\u093E, \u0938\u094D\u0915\u0942\u0932 \u092D\u0940 \u0928\u0939\u0940\u0902 \u0932\u093E \u0938\u0915\u0924\u093E\u0964",
    S.eraseAction to "\u0939\u091F\u093E\u090F\u0901",
    S.eraseConfirm to "\u0939\u093E\u0901, \u0939\u091F\u093E\u090F\u0901",
    S.childErased to "\u0939\u091F\u093E \u0926\u093F\u092F\u093E \u0917\u092F\u093E\u0964 \u0915\u0941\u091B \u0928\u0939\u0940\u0902 \u092C\u091A\u093E\u0964",
    S.childEraseFailed to "\u0939\u092E \u0907\u0938\u0947 \u0939\u091F\u093E \u0928\u0939\u0940\u0902 \u0938\u0915\u0947\u0964 \u0915\u0943\u092A\u092F\u093E \u0926\u094B\u092C\u093E\u0930\u093E \u0915\u094B\u0936\u093F\u0936 \u0915\u0930\u0947\u0902\u0964",
    S.badgeSuperEater to "\u0938\u0941\u092A\u0930 \u0908\u091F\u0930",
    S.badgeSuperEaterSub to "\u0932\u0917\u093E\u0924\u093E\u0930 7 \u0926\u093F\u0928 \u0939\u0930 \u092D\u094B\u091C\u0928 \u0926\u0930\u094D\u091C \u0915\u093F\u092F\u093E",
    S.badgeEveryMeal to "\u0938\u093E\u092B\u093C \u0925\u093E\u0932\u0940",
    S.badgeEveryMealSub to "\u0906\u091C \u0939\u0930 \u092D\u094B\u091C\u0928 \u0916\u093E\u092F\u093E \u0939\u0941\u0906 \u0926\u0930\u094D\u091C",
    S.badgeThreeDay to "\u0932\u0917\u093E\u0924\u093E\u0930 \u0924\u0940\u0928",
    S.badgeThreeDaySub to "\u0932\u0917\u093E\u0924\u093E\u0930 \u0924\u0940\u0928 \u0926\u093F\u0928 \u092D\u094B\u091C\u0928 \u0926\u0930\u094D\u091C",
    S.badgeTwoWeek to "\u092A\u0902\u0926\u094D\u0930\u0939 \u0926\u093F\u0928 \u0915\u0940 \u0932\u092F",
    S.badgeTwoWeekSub to "\u0938\u092C\u0938\u0947 \u0932\u0902\u092C\u0940 \u0932\u092F 14 \u0926\u093F\u0928",
    S.badgeBrightSmile to "\u091A\u092E\u0915\u0924\u0940 \u092E\u0941\u0938\u094D\u0915\u093E\u0928",
    S.badgeBrightSmileSub to "\u092A\u093F\u091B\u0932\u0940 \u0938\u094D\u0915\u0942\u0932 \u091C\u093E\u0901\u091A \u092E\u0947\u0902 \u0915\u094B\u0908 \u0915\u0948\u0935\u093F\u091F\u0940 \u0928\u0939\u0940\u0902",
    S.badgeBrightSmileUnknown to "\u0915\u0948\u0902\u092A \u092E\u0947\u0902 \u0926\u093E\u0901\u0924\u094B\u0902 \u0915\u0940 \u091C\u093E\u0901\u091A \u0915\u093E \u0907\u0902\u0924\u091C\u093C\u093E\u0930",
    S.badgeHalfWay to "\u0905\u091A\u094D\u091B\u0940 \u0936\u0941\u0930\u0941\u0906\u0924",
    S.badgeHalfWaySub to "\u0906\u091C \u0915\u0947 \u0906\u0927\u0947 \u092D\u094B\u091C\u0928 \u0926\u0930\u094D\u091C",
    S.notScreenedYet to "\u0905\u092D\u0940 \u091C\u093E\u0901\u091A \u0928\u0939\u0940\u0902 \u0939\u0941\u0908",
    S.clearLabel to "\u092E\u093F\u091F\u093E\u090F\u0901",
    S.logLabel to "\u0926\u0930\u094D\u091C \u0915\u0930\u0947\u0902",
    S.foodRecognition to "\u0916\u093E\u0928\u093E \u092A\u0939\u091A\u093E\u0928\u0947\u0902",
    S.navHome to "\u0939\u094B\u092E",
    S.navKids to "\u092C\u091A\u094D\u091A\u0947",
    S.navCamps to "\u0915\u0948\u0902\u092A",
    ...
    S.noGrowthDataSub to "\u090A\u0901\u091A\u093E\u0908 \u0914\u0930 \u0935\u091C\u093C\u0928 \u0938\u094D\u0915\u0942\u0932 \u0938\u094D\u0935\u093E\u0938\u094D\u0925\u094D\u092F \u0915\u0948\u0902\u092A \u092E\u0947\u0902 \u092E\u093E\u092A\u0947 \u091C\u093E\u0924\u0947 \u0939\u0948\u0902\u0964 \u0906\u092A\u0915\u0947 \u092C\u091A\u094D\u091A\u0947 \u0915\u0940 \u091C\u093E\u0901\u091A \u0939\u094B\u0928\u0947 \u092A\u0930 \u092F\u0939 \u091A\u093E\u0930\u094D\u091F \u0926\u093F\u0916\u0947\u0917\u093E\u0964",
)
...
private val te = mapOf(
    ...
    S.heroOfMonthTitle to "\u0C08 \u0C28\u0C46\u0C32 \u0C35\u0C40\u0C1F\u0C3E\u0C39\u0C40\u0C30\u0C4B",
    S.heroNameAskTitle to "\u0C2E\u0C40 \u0C2C\u0C3F\u0C21\u0C4D\u0C21 \u0C0E\u0C02\u0C2A\u0C3F\u0C15\u0C48\u0C24\u0C47",
    S.heroNameAskBody to "\u0C2A\u0C4D\u0C30\u0C24\u0C3F \u0C28\u0C46\u0C32\u0C3E \u0C2A\u0C3E\u0C20\u0C36\u0C3E\u0C32 \u0C12\u0C15 \u0C2C\u0C3F\u0C21\u0C4D\u0C21\u0C28\u0C41 \u0C38\u0C28\u0C4D\u0C2E\u0C3E\u0C28\u0C3F\u0C38\u0C4D\u0C24\u0C41\u0C02\u0C26\u0C3F. \u0C2E\u0C40 \u0C2C\u0C3F\u0C21\u0C4D\u0C21 \u0C0E\u0C02\u0C2A\u0C3F\u0C15\u0C48\u0C24\u0C47 \u0C35\u0C3E\u0C30\u0C3F \u0C2A\u0C47\u0C30\u0C41, \u0C24\u0C30\u0C17\u0C24\u0C3F \u0C07\u0C24\u0C30 \u0C15\u0C41\u0C1F\u0C41\u0C02\u0C2C\u0C3E\u0C32\u0C15\u0C41 \u0C1A\u0C42\u0C2A\u0C3F\u0C02\u0C1A\u0C35\u0C1A\u0C4D\u0C1A\u0C3E? \u0C35\u0C26\u0C4D\u0C26\u0C28\u0C4D\u0C28\u0C3E \u0C15\u0C42\u0C21\u0C3E \u0C0E\u0C02\u0C2A\u0C3F\u0C15 \u0C05\u0C35\u0C41\u0C24\u0C3E\u0C30\u0C41. \u0C0E\u0C2A\u0C4D\u0C2A\u0C41\u0C21\u0C48\u0C28\u0C3E \u0C2E\u0C3E\u0C30\u0C4D\u0C1A\u0C35\u0C1A\u0C4D\u0C1A\u0C41.",
    S.heroNameYes to "\u0C2E\u0C4A\u0C26\u0C1F\u0C3F \u0C2A\u0C47\u0C30\u0C41 \u0C1A\u0C42\u0C2A\u0C02\u0C21\u0C3F",
    S.heroNameNo to "\u0C2A\u0C47\u0C30\u0C41 \u0C1A\u0C42\u0C2A\u0C35\u0C26\u0C4D\u0C26\u0C41",
    S.mealPhotoAskTitle to "\u0C2D\u0C4B\u0C1C\u0C28 \u0C2B\u0C4B\u0C1F\u0C4B\u0C32\u0C41 \u0C0E\u0C15\u0C4D\u0C15\u0C21\u0C3F\u0C15\u0C3F?",
    S.mealPhotoAskBody to "\u0C35\u0C02\u0C1F\u0C15\u0C02 \u0C2A\u0C47\u0C30\u0C41\u0C28\u0C41 \u0C16\u0C1A\u0C4D\u0C1A\u0C3F\u0C24\u0C02\u0C17\u0C3E \u0C1A\u0C46\u0C2A\u0C4D\u0C2A\u0C21\u0C3E\u0C28\u0C3F\u0C15\u0C3F \u0C2B\u0C4B\u0C1F\u0C4B\u0C28\u0C3F \u0C2E\u0C3E \u0C38\u0C30\u0C4D\u0C35\u0C30\u0C4D\u0C15\u0C41 \u0C2A\u0C02\u0C2A\u0C35\u0C1A\u0C4D\u0C1A\u0C41. \u0C32\u0C47\u0C26\u0C3E \u0C08 \u0C2B\u0C4B\u0C28\u0C4D\u200C\u0C32\u0C4B\u0C28\u0C47 \u0C1A\u0C26\u0C35\u0C35\u0C1A\u0C4D\u0C1A\u0C41, \u0C2B\u0C4B\u0C1F\u0C4B \u0C0E\u0C2A\u0C4D\u0C2A\u0C41\u0C21\u0C42 \u0C2C\u0C2F\u0C1F\u0C15\u0C41 \u0C35\u0C46\u0C33\u0C4D\u0C32\u0C26\u0C41. \u0C30\u0C46\u0C02\u0C21\u0C3F\u0C02\u0C1F\u0C3F\u0C32\u0C4B\u0C28\u0C42 \u0C2D\u0C4B\u0C1C\u0C28\u0C02 \u0C28\u0C2E\u0C4B\u0C26\u0C35\u0C41\u0C24\u0C41\u0C02\u0C26\u0C3F. \u0C24\u0C30\u0C4D\u0C35\u0C3E\u0C24 \u0C2E\u0C3E\u0C30\u0C4D\u0C1A\u0C41\u0C15\u0C4B\u0C35\u0C1A\u0C4D\u0C1A\u0C41.",
    S.mealPhotoAllow to "\u0C2B\u0C4B\u0C1F\u0C4B\u0C32\u0C41 \u0C2A\u0C02\u0C2A\u0C02\u0C21\u0C3F",
    S.mealPhotoKeepOnPhone to "\u0C2B\u0C4B\u0C28\u0C4D\u200C\u0C32\u0C4B\u0C28\u0C47 \u0C09\u0C02\u0C1A\u0C02\u0C21\u0C3F",
    S.mealPhotoOnDevice to "\u0C2B\u0C4B\u0C1F\u0C4B\u0C32\u0C41 \u0C08 \u0C2B\u0C4B\u0C28\u0C4D\u200C\u0C32\u0C4B\u0C28\u0C47 \u0C1A\u0C26\u0C35\u0C2C\u0C21\u0C24\u0C3E\u0C2F\u0C3F, \u0C2A\u0C02\u0C2A\u0C2C\u0C21\u0C35\u0C41.",
    ...
    S.symptomsNoticeFallback to "\u0C07\u0C26\u0C3F \u0C2E\u0C40 \u0C2C\u0C3F\u0C21\u0C4D\u0C21 \u0C24\u0C26\u0C41\u0C2A\u0C30\u0C3F \u0C2A\u0C30\u0C40\u0C15\u0C4D\u0C37 \u0C15\u0C4B\u0C38\u0C02 \u0C12\u0C15 \u0C17\u0C2E\u0C28\u0C3F\u0C15, \u0C07\u0C2A\u0C4D\u0C2A\u0C41\u0C21\u0C41 \u0C38\u0C3E\u0C2F\u0C02 \u0C2A\u0C4A\u0C02\u0C26\u0C47 \u0C2E\u0C3E\u0C30\u0C4D\u0C17\u0C02 \u0C15\u0C3E\u0C26\u0C41. \u0C2E\u0C40 \u0C2C\u0C3F\u0C21\u0C4D\u0C21\u0C15\u0C41 \u0C08 \u0C30\u0C4B\u0C1C\u0C41 \u0C21\u0C3E\u0C15\u0C4D\u0C1F\u0C30\u0C4D \u0C05\u0C35\u0C38\u0C30\u0C2E\u0C48\u0C24\u0C47, \u0C35\u0C3E\u0C30\u0C3F\u0C28\u0C3F \u0C21\u0C3E\u0C15\u0C4D\u0C1F\u0C30\u0C4D \u0C26\u0C17\u0C4D\u0C17\u0C30\u0C15\u0C41 \u0C24\u0C40\u0C38\u0C41\u0C15\u0C41\u0C35\u0C46\u0C33\u0C4D\u0C32\u0C02\u0C21\u0C3F.",
    S.whatHappened to "\u0C0F\u0C2E\u0C3F \u0C1C\u0C30\u0C3F\u0C17\u0C3F\u0C02\u0C26\u0C3F?",
    S.howBad to "\u0C0E\u0C02\u0C24 \u0C24\u0C40\u0C35\u0C4D\u0C30\u0C02\u0C17\u0C3E \u0C09\u0C02\u0C26\u0C3F?",
    S.severityMild to "\u0C24\u0C47\u0C32\u0C3F\u0C15\u0C2A\u0C3E\u0C1F\u0C3F",
    S.severityModerate to "\u0C06\u0C02\u0C26\u0C4B\u0C33\u0C28 \u0C15\u0C32\u0C3F\u0C17\u0C3F\u0C02\u0C1A\u0C47\u0C02\u0C24",
    S.whenStarted to "\u0C0E\u0C2A\u0C4D\u0C2A\u0C41\u0C21\u0C41 \u0C2E\u0C4A\u0C26\u0C32\u0C48\u0C02\u0C26\u0C3F?",
    S.dayToday to "\u0C08 \u0C30\u0C4B\u0C1C\u0C41",
    S.dayYesterday to "\u0C28\u0C3F\u0C28\u0C4D\u0C28",
    S.dayNAgo to "%s \u0C30\u0C4B\u0C1C\u0C41\u0C32 \u0C15\u0C4D\u0C30\u0C3F\u0C24\u0C02",
    S.stillUnwell to "\u0C07\u0C02\u0C15\u0C3E \u0C05\u0C28\u0C3E\u0C30\u0C4B\u0C17\u0C4D\u0C2F\u0C02\u0C17\u0C3E \u0C09\u0C02\u0C26\u0C3F",
    S.missedSchool to "\u0C2A\u0C3E\u0C20\u0C36\u0C3E\u0C32\u0C15\u0C41 \u0C35\u0C46\u0C33\u0C4D\u0C32\u0C32\u0C47\u0C26\u0C41",
    S.sawADoctor to "\u0C2E\u0C47\u0C2E\u0C41 \u0C21\u0C3E\u0C15\u0C4D\u0C1F\u0C30\u0C4D\u200C\u0C28\u0C41 \u0C15\u0C32\u0C3F\u0C36\u0C3E\u0C2E\u0C41",
    S.symptomNoteHint to "\u0C07\u0C02\u0C15\u0C47\u0C2E\u0C48\u0C28\u0C3E \u0C1A\u0C46\u0C2A\u0C4D\u0C2A\u0C3E\u0C32\u0C28\u0C41\u0C15\u0C41\u0C02\u0C1F\u0C47 (\u0C10\u0C1A\u0C4D\u0C1B\u0C3F\u0C15\u0C02)",
    S.saveSymptom to "\u0C38\u0C47\u0C35\u0C4D \u0C1A\u0C47\u0C2F\u0C02\u0C21\u0C3F",
    S.symptomNotADiagnosis to "\u0C07\u0C26\u0C3F \u0C2E\u0C40\u0C30\u0C41 \u0C1A\u0C46\u0C2A\u0C4D\u0C2A\u0C3F\u0C28 \u0C35\u0C3F\u0C35\u0C30\u0C23, \u0C30\u0C4B\u0C17 \u0C28\u0C3F\u0C30\u0C4D\u0C27\u0C3E\u0C30\u0C23 \u0C15\u0C3E\u0C26\u0C41. \u0C24\u0C26\u0C41\u0C2A\u0C30\u0C3F \u0C36\u0C3F\u0C2C\u0C3F\u0C30\u0C02\u0C32\u0C4B\u0C28\u0C3F \u0C21\u0C3E\u0C15\u0C4D\u0C1F\u0C30\u0C4D \u0C26\u0C40\u0C28\u0C4D\u0C28\u0C3F \u0C1A\u0C26\u0C35\u0C17\u0C32\u0C30\u0C41.",
    S.symptomSaved to "\u0C38\u0C47\u0C35\u0C4D \u0C1A\u0C47\u0C2F\u0C2C\u0C21\u0C3F\u0C02\u0C26\u0C3F.",
    S.symptomFailed to "\u0C2E\u0C47\u0C2E\u0C41 \u0C26\u0C3E\u0C28\u0C3F\u0C28\u0C3F \u0C38\u0C47\u0C35\u0C4D \u0C1A\u0C47\u0C2F\u0C32\u0C47\u0C15\u0C2A\u0C4B\u0C2F\u0C3E\u0C2E\u0C41. \u0C26\u0C2F\u0C1A\u0C47\u0C38\u0C3F \u0C2E\u0C33\u0C4D\u0C32\u0C40 \u0C2A\u0C4D\u0C30\u0C2F\u0C24\u0C4D\u0C28\u0C3F\u0C02\u0C1A\u0C02\u0C21\u0C3F.",
    S.seeADoctor to "\u0C21\u0C3E\u0C15\u0C4D\u0C1F\u0C30\u0C4D\u200C\u0C28\u0C41 \u0C15\u0C32\u0C35\u0C02\u0C21\u0C3F",
    S.pastIllnesses to "\u0C2E\u0C40\u0C30\u0C41 \u0C28\u0C2E\u0C4B\u0C26\u0C41 \u0C1A\u0C47\u0C38\u0C3F\u0C28\u0C35\u0C3F",
    S.pastIllnessesSub to "\u0C2E\u0C40 \u0C2C\u0C3F\u0C21\u0C4D\u0C21 \u0C24\u0C26\u0C41\u0C2A\u0C30\u0C3F \u0C36\u0C3F\u0C2C\u0C3F\u0C30\u0C02\u0C32\u0C4B\u0C28\u0C3F \u0C21\u0C3E\u0C15\u0C4D\u0C1F\u0C30\u0C4D \u0C26\u0C40\u0C28\u0C4D\u0C28\u0C3F \u0C1A\u0C42\u0C21\u0C17\u0C32\u0C30\u0C41.",
    S.ongoingLabel to "\u0C15\u0C4A\u0C28\u0C38\u0C3E\u0C17\u0C41\u0C24\u0C4B\u0C02\u0C26\u0C3F",
    S.eraseTitle to "\u0C2C\u0C3F\u0C21\u0C4D\u0C21 \u0C30\u0C3F\u0C15\u0C3E\u0C30\u0C4D\u0C21\u0C41\u0C28\u0C41 \u0C24\u0C4A\u0C32\u0C17\u0C3F\u0C02\u0C1A\u0C02\u0C21\u0C3F",
    S.eraseBody to "\u0C07\u0C26\u0C3F \u0C05\u0C28\u0C4D\u0C28\u0C3F\u0C02\u0C1F\u0C3F\u0C28\u0C40 \u0C24\u0C4A\u0C32\u0C17\u0C3F\u0C38\u0C4D\u0C24\u0C41\u0C02\u0C26\u0C3F: \u0C36\u0C3F\u0C2C\u0C3F\u0C30 \u0C2B\u0C32\u0C3F\u0C24\u0C3E\u0C32\u0C41, \u0C24\u0C26\u0C41\u0C2A\u0C30\u0C3F \u0C1A\u0C30\u0C4D\u0C2F\u0C32\u0C41, \u0C2B\u0C4B\u0C1F\u0C4B\u0C32\u0C41 \u0C2E\u0C30\u0C3F\u0C2F\u0C41 \u0C08 \u0C05\u0C28\u0C3E\u0C30\u0C4B\u0C17\u0C4D\u0C2F \u0C28\u0C2E\u0C4B\u0C26\u0C41. \u0C26\u0C40\u0C28\u0C4D\u0C28\u0C3F \u0C24\u0C3F\u0C30\u0C3F\u0C17\u0C3F \u0C2A\u0C4A\u0C02\u0C26\u0C32\u0C47\u0C30\u0C41, \u0C2A\u0C3E\u0C20\u0C36\u0C3E\u0C32 \u0C15\u0C42\u0C21\u0C3E \u0C24\u0C40\u0C38\u0C41\u0C15\u0C41\u0C30\u0C3E\u0C32\u0C47\u0C26\u0C41.",
    S.eraseAction to "\u0C24\u0C4A\u0C32\u0C17\u0C3F\u0C02\u0C1A\u0C41",
    S.eraseConfirm to "\u0C05\u0C35\u0C41\u0C28\u0C41, \u0C24\u0C4A\u0C32\u0C17\u0C3F\u0C02\u0C1A\u0C41",
    S.childErased to "\u0C24\u0C4A\u0C32\u0C17\u0C3F\u0C02\u0C1A\u0C2C\u0C21\u0C3F\u0C02\u0C26\u0C3F. \u0C0F\u0C2E\u0C40 \u0C2E\u0C3F\u0C17\u0C32\u0C32\u0C47\u0C26\u0C41.",
    S.childEraseFailed to "\u0C2E\u0C47\u0C2E\u0C41 \u0C26\u0C3E\u0C28\u0C3F\u0C28\u0C3F \u0C24\u0C4A\u0C32\u0C17\u0C3F\u0C02\u0C1A\u0C32\u0C47\u0C15\u0C2A\u0C4B\u0C2F\u0C3E\u0C2E\u0C41. \u0C26\u0C2F\u0C1A\u0C47\u0C38\u0C3F \u0C2E\u0C33\u0C4D\u0C32\u0C40 \u0C2A\u0C4D\u0C30\u0C2F\u0C24\u0C4D\u0C28\u0C3F\u0C02\u0C1A\u0C02\u0C21\u0C3F.",
    S.badgeSuperEater to "\u0C38\u0C42\u0C2A\u0C30\u0C4D \u0C08\u0C1F\u0C30\u0C4D",
    S.badgeSuperEaterSub to "\u0C35\u0C30\u0C41\u0C38\u0C17\u0C3E 7 \u0C30\u0C4B\u0C1C\u0C41\u0C32\u0C41 \u0C2A\u0C4D\u0C30\u0C24\u0C3F \u0C2D\u0C4B\u0C1C\u0C28\u0C02 \u0C28\u0C2E\u0C4B\u0C26\u0C41 \u0C1A\u0C47\u0C36\u0C3E\u0C30\u0C41",
    S.badgeEveryMeal to "\u0C16\u0C3E\u0C33\u0C40 \u0C2A\u0C4D\u0C32\u0C47\u0C1F\u0C4D",
    S.badgeEveryMealSub to "\u0C08 \u0C30\u0C4B\u0C1C\u0C41 \u0C2A\u0C4D\u0C30\u0C24\u0C3F \u0C2D\u0C4B\u0C1C\u0C28\u0C02 \u0C24\u0C3F\u0C28\u0C4D\u0C28\u0C1F\u0C4D\u0C1F\u0C41 \u0C28\u0C2E\u0C4B\u0C26\u0C41",
    S.badgeThreeDay to "\u0C35\u0C30\u0C41\u0C38\u0C17\u0C3E \u0C2E\u0C42\u0C21\u0C41",
    S.badgeThreeDaySub to "\u0C35\u0C30\u0C41\u0C38\u0C17\u0C3E \u0C2E\u0C42\u0C21\u0C41 \u0C30\u0C4B\u0C1C\u0C41\u0C32\u0C41 \u0C2D\u0C4B\u0C1C\u0C28\u0C02 \u0C28\u0C2E\u0C4B\u0C26\u0C41",
    S.badgeTwoWeek to "\u0C2A\u0C15\u0C4D\u0C37\u0C02 \u0C30\u0C4B\u0C1C\u0C41\u0C32 \u0C35\u0C30\u0C41\u0C38",
    S.badgeTwoWeekSub to "\u0C05\u0C24\u0C4D\u0C2F\u0C41\u0C24\u0C4D\u0C24\u0C2E \u0C35\u0C30\u0C41\u0C38 14 \u0C30\u0C4B\u0C1C\u0C41\u0C32\u0C41",
    S.badgeBrightSmile to "\u0C2E\u0C46\u0C30\u0C3F\u0C38\u0C47 \u0C1A\u0C3F\u0C30\u0C41\u0C28\u0C35\u0C4D\u0C35\u0C41",
    S.badgeBrightSmileSub to "\u0C17\u0C24 \u0C2A\u0C3E\u0C20\u0C36\u0C3E\u0C32 \u0C2A\u0C30\u0C40\u0C15\u0C4D\u0C37\u0C32\u0C4B \u0C2A\u0C33\u0C4D\u0C32 \u0C2A\u0C41\u0C1A\u0C4D\u0C1A\u0C41 \u0C32\u0C47\u0C26\u0C41",
    S.badgeBrightSmileUnknown to "\u0C36\u0C3F\u0C2C\u0C3F\u0C30\u0C02\u0C32\u0C4B \u0C26\u0C02\u0C24 \u0C2A\u0C30\u0C40\u0C15\u0C4D\u0C37 \u0C15\u0C4B\u0C38\u0C02 \u0C0E\u0C26\u0C41\u0C30\u0C41 \u0C1A\u0C42\u0C38\u0C4D\u0C24\u0C4B\u0C02\u0C26\u0C3F",
    S.badgeHalfWay to "\u0C2E\u0C02\u0C1A\u0C3F \u0C06\u0C30\u0C02\u0C2D\u0C02",
    S.badgeHalfWaySub to "\u0C08 \u0C30\u0C4B\u0C1C\u0C41 \u0C38\u0C17\u0C02 \u0C2D\u0C4B\u0C1C\u0C28\u0C3E\u0C32\u0C41 \u0C28\u0C2E\u0C4B\u0C26\u0C41",
    S.notScreenedYet to "\u0C07\u0C02\u0C15\u0C3E \u0C2A\u0C30\u0C40\u0C15\u0C4D\u0C37\u0C3F\u0C02\u0C1A\u0C32\u0C47\u0C26\u0C41",
    S.clearLabel to "\u0C24\u0C4A\u0C32\u0C17\u0C3F\u0C02\u0C1A\u0C41",
    S.logLabel to "\u0C28\u0C2E\u0C4B\u0C26\u0C41 \u0C1A\u0C47\u0C2F\u0C02\u0C21\u0C3F",
    S.foodRecognition to "\u0C06\u0C39\u0C3E\u0C30\u0C3E\u0C28\u0C4D\u0C28\u0C3F \u0C17\u0C41\u0C30\u0C4D\u0C24\u0C3F\u0C02\u0C1A\u0C02\u0C21\u0C3F",
    S.navHome to "\u0C39\u0C4B\u0C2E\u0C4D",
    S.navKids to "\u0C2A\u0C3F\u0C32\u0C4D\u0C32\u0C32\u0C41",
    ...
    S.noGrowthDataSub to "\u0C0E\u0C24\u0C4D\u0C24\u0C41 \u0C2E\u0C30\u0C3F\u0C2F\u0C41 \u0C2C\u0C30\u0C41\u0C35\u0C41 \u0C2A\u0C3E\u0C20\u0C36\u0C3E\u0C32 \u0C06\u0C30\u0C4B\u0C17\u0C4D\u0C2F \u0C36\u0C3F\u0C2C\u0C3F\u0C30\u0C02\u0C32\u0C4B \u0C15\u0C4A\u0C32\u0C41\u0C38\u0C4D\u0C24\u0C3E\u0C30\u0C41. \u0C2E\u0C40 \u0C2C\u0C3F\u0C21\u0C4D\u0C21\u0C28\u0C41 \u0C2A\u0C30\u0C40\u0C15\u0C4D\u0C37\u0C3F\u0C02\u0C1A\u0C3F\u0C28 \u0C24\u0C30\u0C4D\u0C35\u0C3E\u0C24 \u0C08 \u0C1A\u0C3E\u0C30\u0C4D\u0C1F\u0C4D \u0C15\u0C28\u0C3F\u0C2A\u0C3F\u0C38\u0C4D\u0C24\u0C41\u0C02\u0C26\u0C3F.",
)
